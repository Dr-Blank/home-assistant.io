...
A climate entity and four button entities are created for each Fujitsu General air conditioner device you set up. If you also set up an infrared receiver, an event entity is created for the buttons pressed on the physical remote.
...
Turning swing off stops the louvre, but which position it stops in is decided by the air conditioner, not by the command. Use the louvre position buttons to move it from there.
